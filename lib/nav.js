...
(function (global) {
  ...
  const ICONS = {
    ...
    walking:     SVG_HEAD + '<circle cx="13" cy="4" r="2"/><path d="M13 7l-3 5l4 2v6"/><path d="M10 12l-3 4"/><path d="M14 14l3 3"/><path d="M14 20l-2 2"/></svg>',
  ...
  const ITEMS = [
    ...
    { id: 'WHAT',  label: 'WHAT',  href: 'what.html',  group: 'OBSERVATION', icon: 'car' },
    { id: 'SCRIM', label: 'SCRIM', href: 'scrim.html', group: 'OBSERVATION', icon: 'tank' },
