...
(function (global) {
  ...
  const ITEMS = [
    ...
    // SKOLA — utbildning och referenser.
    { id: 'SIGSKYDD', label: 'SIGSKYDD', href: 'sigskydd.html', group: 'SKOLA' },
    { id: 'RA763',    label: 'RA763',    href: 'ra763.html',    group: 'SKOLA' },
    { id: 'FORKORT',  label: 'FÖRKORT',  href: 'forkort.html',  group: 'SKOLA' },
    { id: 'FG',       label: 'FG',       href: 'fg.html',       group: 'SKOLA' },
    { id: 'SYMBOL',   label: 'SYMBOL',   href: 'symbol.html',   group: 'SKOLA' },

    // RAMSOR — har egen intern matrix + roll-picker, rörs inte.
    { id: 'RAMSOR', label: 'RAMSOR', href: 'ramsor.html', group: 'RAMSOR' },

    // HIDDEN — "Visa dolda"-toggle. APP-6 deduplikerad från SKOLA hit.
