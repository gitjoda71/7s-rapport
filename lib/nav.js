...
(function (global) {
  ...
  const ICONS = {
    ...
    car:        SVG_HEAD + '<path d="M5 17h14"/><path d="M3 17V12l2-4h14l2 4v5"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M6 12h12"/></svg>',
  ...
  const ITEMS = [
    ...
    { id: 'WHAT',  label: 'WHAT',  href: 'what.html',  group: 'OBSERVATION', icon: 'bubble' },
    ...
    { id: 'AH',    label: 'A–H',   href: 'ah.html',    group: 'OBSERVATION', icon: 'book' },
    ...
    { id: 'PEDARS',   label: 'PEDARS',   href: 'pedars.html',   group: 'RAPPORT', icon: 'search' },
    { id: 'EOBUSARE', label: 'EOBUSARE', href: 'eobusare.html', group: 'RAPPORT', icon: 'shield' },
    { id: 'RASSOIKA', label: 'RASSOIKA', href: 'rassoika.html', group: 'RAPPORT', icon: 'compass' },

    // PLANERING — kartor, schema, väder.
    { id: 'MINKARTA',    label: 'MINKARTA',    href: 'minkarta.html',    group: 'PLANERING', icon: 'map' },
    { id: 'SENSORSKISS', label: 'SENSORSKISS', href: 'sensorskiss.html', group: 'PLANERING', icon: 'radar' },
    { id: 'SCHEMA',      label: 'SCHEMA',      href: 'postschema.html',  group: 'PLANERING', icon: 'calendar' },
    { id: 'VADER',       label: 'VÄDER',       href: 'vader.html',       group: 'PLANERING', icon: 'cloud' },

    // ADMIN — mätningar, skytte, kontrollrapporter.
    { id: 'MATT',   label: 'MÅTT',   href: 'matt.html',      group: 'ADMIN', icon: 'tape' },
    { id: 'SKYTTE', label: 'SKYTTE', href: 'skyttebok.html', group: 'ADMIN', icon: 'target' },
    ...
    { id: 'PATL',   label: 'PATL',   href: 'patl.html',      group: 'ADMIN', icon: 'person' },
